...
def history_post():
    ...
    conn = mysql.connection.cursor()
    conn.execute("INSERT INTO history (nama,email,dosen, keperluan )VALUES ('"+nama+"','"+email+"','"+dosen+"','"+keperluan+"')")
    mysql.connection.commit()
...
def predict():
        ...
        image_1 = face_recognition.load_image_file("dataset/anam/Dh (9).jpg")
        image_1_face_encoding = face_recognition.face_encodings(image_1)[0]
            
        image_2 = face_recognition.load_image_file("dataset/dimas/modi (1).jpg")
        image_2_face_encoding = face_recognition.face_encodings(image_2)[0]
        
        image_3 = face_recognition.load_image_file("dataset/salman/yuvi (21).jpg")
